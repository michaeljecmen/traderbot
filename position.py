...
class OpenStockPosition:
    ...
    def __init__(self, ticker, budget):
        ...
        print_with_lock("opened {} position: {} shares at {} for ${}".format(ticker, self.quantity, self.open_price, self.quantity*self.open_price))
    ...
    def close(self):
        ...
        print_with_lock("sold {} shares of {} (total of ${}) for a net {} of {}".format(
            self.quantity, self.ticker, close_price*self.quantity, "gain" if close_price > self.open_price else "loss", close_price-self.open_price))
        pass # TODO
...
class OpenPaperPosition:
    ...
    def __init__(self, ticker, budget, market_data):
        ...
        self.open_price = market_data.get_next_data_for_ticker(ticker)
